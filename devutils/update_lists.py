...
PRUNING_EXCLUDE_PATTERNS = [
    ...
    # Exclusions for Hydrogen onboarding
    'components/hydrogen_onboarding/node_modules/@esbuild/*/bin/esbuild',
    'components/hydrogen_onboarding/node_modules/@esbuild/*/esbuild.exe',
    'components/hydrogen_onboarding/node_modules/@rollup/*/rollup.*.node',
    'components/hydrogen_onboarding/node_modules/fsevents/fsevents.node',
...
DOMAIN_EXCLUDE_PREFIXES = [
    ...
    # Hydrogen components
    'third_party/ublock/',
    'components/hydrogen_onboarding/',
]
