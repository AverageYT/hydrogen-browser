...
2. **Brand names**: "Hydrogen" is a product name. Never translate it. Other product/brand names (e.g. "uBlock Origin") must also be kept as-is. Translate non-brand feature and layout names when that is natural for the target language.
...
10. **Browser style**: Hydrogen is a Chromium-based browser. Use terminology and phrasing that match established browser UI translations for the target language, especially Chromium/Chrome-style translations for common browser concepts.
