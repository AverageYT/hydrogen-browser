# Hydrogen i18n
This directory contains the translations for Hydrogen browser UI strings.
...
batches][pr], if you would like to contribute to the translation of Hydrogen,
...
- "Hydrogen" and other brand names should not be translated
...
## Development
When adding strings to Hydrogen, you might need to regenerate the source
