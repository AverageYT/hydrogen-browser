...
"""Script to replace instances of Chrome/Chromium with Hydrogen"""
...
def replacement_sanity():
    ...
    before_after = [
        ('chrome://about', 'hydrogen://about'),
        ('Chrome Root Program', 'Chrome Root Program'),
        (' Chrome  ', ' Hydrogen  '),
        ('Chrome Web Store', 'Chrome Web Store'),
        ('Chromium Web Store', 'Chromium Web Store'),
        ('Chrome Remote Desktop', 'Chrome Remote Desktop'),
        ('Google Chrome', 'Hydrogen'),
        ('Chrome Google Chrome Chrome Chromium', 'Hydrogen Hydrogen Hydrogen Hydrogen'),
        ('Chrome', 'Hydrogen'),
        ('Chromium', 'Hydrogen'),
    ]
